...
export const createFilterTemplate = (filterAvailability = {}, currentFilter = FilterType.EVERYTHING) => {
  ...
  const isFutureDisabled = !isFutureAvailable && currentFilter !== FilterType.FUTURE;
  const isPastDisabled = !isPastAvailable && currentFilter !== FilterType.PAST;
  const isPresentDisabled = !isPresentAvailable && currentFilter !== FilterType.PRESENT;
